...
#define LED_NUM 60  // кол-во светодиодов
...
#define MIN_SPEED 2  // минимальная скорость
#define MAX_SPEED 17  // максимальная скорость
